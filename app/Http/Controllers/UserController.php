                ...
                return DataTables::of($data)
                                 ...
                                 ->addColumn('action', function($row){
                                     ...
                                     $actionBtn =   '<a href="'.$viewUrl.'" class="view btn btn-success btn-sm btn-table"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                                    ...
                                                    <a data-bs-toggle="modal" data-id="' . $row->id . '" data-link="' . $deleteUrl . '" data-bs-target="#deleteModal" title="Delete Role" href="#" class="item-delete btn btn-danger btn-sm btn-table '.($row->id == auth()->id() ? 'disabled' : '').'"><i class="fa fa-trash-o" aria-hidden="true"></i></a>';
                                     return $actionBtn;
                                 })
                                 ->rawColumns(['action'])
                                 ->make(true);
